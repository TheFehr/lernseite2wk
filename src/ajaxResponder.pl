...
my ($db_host, $db_user, $db_name, $db_pass) = ('mariaDB', 'docker', 'media', 'my-secure-password');
my $db = DBI->connect("DBI:mysql:$db_name:$db_host", $db_user, $db_pass, {RaiseError => 1, PrintError => 1, mysql_enable_utf8 => 1});
